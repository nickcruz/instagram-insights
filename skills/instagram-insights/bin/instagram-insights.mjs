...
var require_arg_decorator = __commonJS({
  "../../node_modules/commander-ts/dist/decorators/arg.decorator.js"(exports) {
    ...
    function variadicArg2(name) {
      return (target, propertyKey, parameterIndex) => {
        const args = (0, utils_1.decorateIfNot)(metadata_1.ArgsMetadata, [], target, propertyKey);
        args.unshift(new models_1.VariadicArg(name, parameterIndex));
      };
    }
    exports.variadicArg = variadicArg2;
  }
});
...
function sha256Base64Url(input) {
  return crypto2.createHash("sha256").update(input).digest("base64url");
}
...
__decorateClass([
  __decorateParam(0, (0, import_commander_ts.variadicArg)("args"))
], InstagramInsightsCli.prototype, "run", 1);
__decorateClass([
